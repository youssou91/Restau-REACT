...
import {AiOutlineMenu, AiOutlineSearch, AiOutlineClose, AiFilterTag } from 'react-icons/ai'
...
const TopNav = () => {
  ...
  return (
    <div className='max-w-[1520px] mx-auto flex justify-between items-center p-4'>
        ...
        <div className='bg-gray-200 rounded-full flex items-center px-2 sm:w-[200px] lg:w-[500PX]'>
